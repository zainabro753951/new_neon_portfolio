        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
          ...
          <div ref={textRef} className="text-center lg:text-left z-10">
            ...
            >
              {headingText.split('').map((char, index) => (
                <span
                  ...
                  style={{
                    color: char === ' ' ? 'transparent' : index > 6 ? '#00d4ff' : '#ffffff',
                    textShadow: index > 6 ? '0 0 30px rgba(0, 212, 255, 0.5)' : 'none',
                  }}
                >
                  {char === ' ' ? '\u00A0' : char}
                </span>
            ...
            <p className="subheading text-gray-500 max-w-lg mx-auto lg:mx-0 mb-10">
              I craft digital experiences that merge art with functionality.
              Specializing in modern web development and stunning UI/UX design.
            </p>
