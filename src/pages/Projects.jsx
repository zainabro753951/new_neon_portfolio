...
import { 
  ExternalLink, Github, ArrowRight, X,
  Code, Palette, Zap
} from 'lucide-react'
  ...
  const projects = [
    {
      ...
      category: 'web',
      description: 'A stunning 3D visualization platform showcasing abstract art with immersive interactions.',
      image: project1,
    ...
    },
    {
      ...
      title: 'Neon Dreams',
      category: 'design',
      description: 'Brand identity and visual design for a futuristic tech startup.',
      image: project2,
    ...
    },
    {
      ...
      title: 'Cyber Portal',
      category: 'web',
      description: 'High-performance dashboard with real-time data visualization and analytics.',
      image: project3,
    ...
    },
    {
      ...
      title: 'Crystal Flow',
      category: 'motion',
      description: 'Motion graphics and animations for a premium product launch campaign.',
      image: project4,
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-8 relative">
          ...
          >
            ...
            <p className="text-gray-400 text-lg max-w-2xl mx-auto">
              ...
              design, and motion graphics projects.
            </p>
          </motion.div>
        </div>
      </section>
        ...
        {selectedProject && (
          ...
          >
            ...
            >
              ...
              {/* Content */}
              <div className="p-8">
                <div className={`w-14 h-14 rounded-xl bg-gradient-to-r ${selectedProject.color} flex items-center justify-center mb-6`}>
